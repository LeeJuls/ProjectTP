...
기존 자율 경계 제약 4번(*"S1 봉인 확보 후 착수"*)이 폐기되고 **착수 순서가 역전**됐다. 근거: [[../../../자율진행_plan_v2|자율진행_plan_v2]] §5 자율 경계 v2 제약 4번(개정판) · §4-2 의존 그래프 v4.
...
**본 문서와의 정합**: 이 순서 변경은 §1~§8의 설계 내용(MA 정의·Delay 0 규약·스캐폴드 명세·타겟 명시 주입·게이트 대응표)을 **하나도 바꾸지 않는다** — 바뀐 것은 "언제 착수하느냐"뿐이다. §9-0 ★3(조회 세션 편승처)은 AT5/AT6-a에서 **AT4-b-2**로 갱신됐다(위 §9-0 "### 3" 절 후속 갱신 참조, [[../../../자율진행_plan_v2|자율진행_plan_v2]] §3 AT트랙 표 `AT4-b-2` 행).
