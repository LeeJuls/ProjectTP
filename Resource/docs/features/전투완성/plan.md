...
| 파트3 | 막기·치유 연출(걸음·카메라·잔상·피격리액션이 스킬 Target/Kind를 반영하도록) | 파트1·2와 접점 0(병행 가능) | 착수 대기 |
