...
type: plan
feature: 걸어나오기연출
status: W0~W2 완료, W3 부분판정(3/8 PASS + 5/8 이월/정적보증)(※ 분모 8 = 전 9항목 중 WT-22 "미실시" 제외. 2026-08-11 확인), W3fix 완료(걸음 왜곡 핫픽스, WT-23 PASS), 공중부양fix 완료(사선무대 접지 — 도착Z 바닥 라인트레이스+발오프셋, 오너 육안 통과, [[공중부양_수정]])
updated: 2026-07-15
---
