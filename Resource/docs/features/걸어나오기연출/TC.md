...
feature: 걸어나오기연출
status: ARCHIVED
status_note: W1 8/8 통과, W2 4/4 판정 완료(3 통과+1 부분통과/명세편차 발견), W3 부분 판정(3/8 PASS + 5/8 이월/정적보증)(※ 분모 8 = 전 9항목 중 WT-22 "미실시" 제외. 2026-08-11 확인), W3fix WT-23 PASS(걸음 왜곡 핫픽스) — [director 판정] 동결. W3 이월분은 아래 원문 참고
updated: 2026-07-16
---
