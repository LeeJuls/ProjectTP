...
feature: 옥토패스대치
status: ARCHIVED
status_note: 진행중 — [director 판정] 기능 동결 — 아래 원문의 '진행중'은 스테일
updated: 2026-07-06
---
...
## 1. 방향 규칙 (확정)
> ⚠ **2026-07-06 오너 요청으로 반전됨**: 아래는 G1/S2 게이트 통과 당시(마주보기)의 원 규칙. 오너가 "party와 enemy 바라보는 방향을 반대로" 요청 후 확인("방향 맞아")해 **현재는 정반대가 기준**(적=좌향/FaceLeft=true, 아군=우향/FaceLeft=false — 서로 등짐). 실측 최신값은 [[raw/S2p_초기배치백업]] 표 참조. TC-28(아래 F 섹션)도 이 반전 기준으로 갱신.
...
- 캡처: [[raw/S2_A안.webp]](채택) · [[raw/S2_B안참고.webp]](기각 — 진영 비대칭·겹침)
...
- High [TC-28] **방향 반전 상태**(적=좌향·아군=우향, §1 2026-07-06 갱신 참조)+원근사선+애니 동시성립 | 대기
