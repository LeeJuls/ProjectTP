...
- **▶ 현재 마일스톤: 알파** — [[로드맵_버전계획]] 확정(2026-07-08). 대기실(뽑기·편성)→전투(턴제 완성형 vs AI)→결과 루프. 개발 계획 수립 단계.
...
## 🌱 병행 기획 구상 (별개 아이디어, projectTP 무관)

- [[신규기획_판타지스쿼드점령전]] — 3인칭 4:4 판타지 스쿼드 점령전 아이디어(오너 구상 시작 2026-07-11). 논의 단계, 개발 착수 아님.
